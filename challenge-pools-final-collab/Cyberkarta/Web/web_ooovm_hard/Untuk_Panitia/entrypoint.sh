...
CREATE TABLE $DB_NAME.something (
    flag VARCHAR(255) NOT NULL
);

CREATE USER '$DB_USER'@'%';
GRANT SELECT, UPDATE, INSERT ON *.* TO '$DB_USER'@'%';
ALTER USER 'root'@'localhost' IDENTIFIED BY 'ad0a521de39eb53ed8a7c36b7b334e12';
FLUSH PRIVILEGES;

INSERT INTO $DB_NAME.something (flag) VALUES('FindITCTF{w0w_y0ur3_93n1u5}');
EOF

# Add SECRET used for cookie signing
sed -i "s/ad0a521de39eb53ed8a7c36b7b334e12/$SECRET/g" /www/index.php
